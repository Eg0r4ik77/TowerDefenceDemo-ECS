...
public partial class GameEntity {
    ...
    public Code.Gameplay.Damage.EffectValue effectValue { get { return (Code.Gameplay.Damage.EffectValue)GetComponent(GameComponentsLookup.EffectValue); } }
    ...
    public GameEntity AddEffectValue(float newValue) {
        ...
        var component = (Code.Gameplay.Damage.EffectValue)CreateComponent(index, typeof(Code.Gameplay.Damage.EffectValue));
