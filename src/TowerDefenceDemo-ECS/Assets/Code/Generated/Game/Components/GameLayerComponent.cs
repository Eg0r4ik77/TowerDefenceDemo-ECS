...
public partial class GameEntity {
    ...
    public Code.Common.Layer layer { get { return (Code.Common.Layer)GetComponent(GameComponentsLookup.Layer); } }
    public Code.Common.EntityLayer Layer { get { return layer.Value; } }
    public bool hasLayer { get { return HasComponent(GameComponentsLookup.Layer); } }

    public GameEntity AddLayer(Code.Common.EntityLayer newValue) {
        var index = GameComponentsLookup.Layer;
        var component = (Code.Common.Layer)CreateComponent(index, typeof(Code.Common.Layer));
        component.Value = newValue;
        AddComponent(index, component);
        return this;
    }

    public GameEntity ReplaceLayer(Code.Common.EntityLayer newValue) {
        var index = GameComponentsLookup.Layer;
        var component = (Code.Common.Layer)CreateComponent(index, typeof(Code.Common.Layer));
        component.Value = newValue;
