...
public partial class GameEntity {
    ...
    public Code.Gameplay.Movement.Rotation rotation { get { return (Code.Gameplay.Movement.Rotation)GetComponent(GameComponentsLookup.Rotation); } }
    ...
    public GameEntity AddRotation(UnityEngine.Quaternion newValue) {
        ...
        var component = (Code.Gameplay.Movement.Rotation)CreateComponent(index, typeof(Code.Gameplay.Movement.Rotation));
