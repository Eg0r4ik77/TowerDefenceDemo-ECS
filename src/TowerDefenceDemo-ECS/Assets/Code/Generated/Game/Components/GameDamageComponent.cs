...
public partial class GameEntity {
    ...
    public Code.Gameplay.Damage.Damage damage { get { return (Code.Gameplay.Damage.Damage)GetComponent(GameComponentsLookup.Damage); } }
    ...
    public GameEntity AddDamage(float newValue) {
        ...
        var component = (Code.Gameplay.Damage.Damage)CreateComponent(index, typeof(Code.Gameplay.Damage.Damage));
