...
public partial class GameEntity {
    ...
    public Gameplay.Enemies.EnemySpawnTimer enemySpawnTimer { get { return (Gameplay.Enemies.EnemySpawnTimer)GetComponent(GameComponentsLookup.EnemySpawnTimer); } }
    ...
    public GameEntity AddEnemySpawnTimer(float newValue) {
        ...
        var component = (Gameplay.Enemies.EnemySpawnTimer)CreateComponent(index, typeof(Gameplay.Enemies.EnemySpawnTimer));
