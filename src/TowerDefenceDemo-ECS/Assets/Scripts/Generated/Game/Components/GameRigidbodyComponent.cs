...
public partial class GameEntity {
    ...
    public Common.RigidbodyComponent rigidbody { get { return (Common.RigidbodyComponent)GetComponent(GameComponentsLookup.Rigidbody); } }
    ...
    public GameEntity AddRigidbody(UnityEngine.Rigidbody newValue) {
        ...
        var component = (Common.RigidbodyComponent)CreateComponent(index, typeof(Common.RigidbodyComponent));
