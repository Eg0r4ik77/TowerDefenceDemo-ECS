...
public partial class GameEntity {
    ...
    public Gameplay.Effects.Damage damage { get { return (Gameplay.Effects.Damage)GetComponent(GameComponentsLookup.Damage); } }
    ...
    public GameEntity AddDamage(float newValue) {
        ...
        var component = (Gameplay.Effects.Damage)CreateComponent(index, typeof(Gameplay.Effects.Damage));
