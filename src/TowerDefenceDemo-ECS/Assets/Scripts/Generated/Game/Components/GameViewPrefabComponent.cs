...
public partial class GameEntity {
    ...
    public Common.ViewPrefab viewPrefab { get { return (Common.ViewPrefab)GetComponent(GameComponentsLookup.ViewPrefab); } }
    public UnityEngine.GameObject ViewPrefab { get { return viewPrefab.Value; } }
    public bool hasViewPrefab { get { return HasComponent(GameComponentsLookup.ViewPrefab); } }

    public GameEntity AddViewPrefab(UnityEngine.GameObject newValue) {
        var index = GameComponentsLookup.ViewPrefab;
        var component = (Common.ViewPrefab)CreateComponent(index, typeof(Common.ViewPrefab));
        component.Value = newValue;
        AddComponent(index, component);
        return this;
    }

    public GameEntity ReplaceViewPrefab(UnityEngine.GameObject newValue) {
        var index = GameComponentsLookup.ViewPrefab;
        var component = (Common.ViewPrefab)CreateComponent(index, typeof(Common.ViewPrefab));
        component.Value = newValue;
