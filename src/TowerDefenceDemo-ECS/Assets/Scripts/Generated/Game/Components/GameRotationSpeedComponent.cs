...
public partial class GameEntity {
    ...
    public Gameplay.Movement.RotationSpeed rotationSpeed { get { return (Gameplay.Movement.RotationSpeed)GetComponent(GameComponentsLookup.RotationSpeed); } }
    ...
    public GameEntity AddRotationSpeed(float newValue) {
        ...
        var component = (Gameplay.Movement.RotationSpeed)CreateComponent(index, typeof(Gameplay.Movement.RotationSpeed));
