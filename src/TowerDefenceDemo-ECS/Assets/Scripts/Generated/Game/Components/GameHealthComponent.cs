...
public partial class GameEntity {
    ...
    public Gameplay.Lifetime.Health health { get { return (Gameplay.Lifetime.Health)GetComponent(GameComponentsLookup.Health); } }
    ...
    public GameEntity AddHealth(float newValue) {
        ...
        var component = (Gameplay.Lifetime.Health)CreateComponent(index, typeof(Gameplay.Lifetime.Health));
