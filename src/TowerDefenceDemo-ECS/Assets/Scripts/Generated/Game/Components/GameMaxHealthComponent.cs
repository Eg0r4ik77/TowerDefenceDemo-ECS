...
public partial class GameEntity {
    ...
    public Gameplay.Lifetime.MaxHealth maxHealth { get { return (Gameplay.Lifetime.MaxHealth)GetComponent(GameComponentsLookup.MaxHealth); } }
    ...
    public GameEntity AddMaxHealth(float newValue) {
        ...
        var component = (Gameplay.Lifetime.MaxHealth)CreateComponent(index, typeof(Gameplay.Lifetime.MaxHealth));
